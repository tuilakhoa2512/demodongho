    ...
    <section class="panel">
      ...
      <div class="panel-body">
        <div class="position-center">
          ...
          <form method="POST" action="{{ route('admin.discount-bills.update', $discount->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" id="name" class="form-control"
                     value="{{ old('name', $discount->name) }}" maxlength="150" required>
            </div>

            <div class="form-group">
              <label for="min_subtotal">Ngưỡng tối thiểu (VNĐ) <span class="text-danger">*</span></label>
              <input type="number" name="min_subtotal" id="min_subtotal" class="form-control"
                     value="{{ old('min_subtotal', $discount->min_subtotal) }}" min="0" step="1000" required>
            ...
            <div class="form-group">
              ...
              <small class="text-muted" style="display:block;margin-top:6px;">
                Trạng thái ưu đãi được bật/tắt ở trang danh sách (icon mắt).
              </small>
            </div>
