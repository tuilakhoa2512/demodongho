                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{ URL::to('/update-product-type/'.$edit_value->id) }}" method="post">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên loại sản phẩm</label>
                                    <input type="text" value="{{ $edit_value->name }}" name="product_type_name" class="form-control" id="exampleInputEmail1" placeholder="Tên Loại sản phẩm">
                                </div>
                                <div class="form-group">
