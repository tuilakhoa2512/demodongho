    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                {{-- ============== KHỐI 1: ẢNH (4 ẢNH TRÊN CÙNG HÀNG) ============== --}}
            ...
            <div class="row">
                ...
                <div class="well" style="padding:12px 15px;">
                    ...
                    <div class="info-row">
                        <div class="info-label">Trạng thái kho</div>
                        <div>
                            @if ($storageDetail)
                                @if ($storageDetail->stock_status === 'pending')
                                    <span class="badge-status label label-warning">Chờ bán</span>
                                @elseif ($storageDetail->stock_status === 'selling')
                                    <span class="badge-status label label-success">Đang bán</span>
                                @elseif ($storageDetail->stock_status === 'sold_out')
                                    <span class="badge-status label label-default">Hết hàng</span>
                                @else
                                    <span class="badge-status label label-danger">Ngừng bán</span>
                                @endif
                        ...
                        <div style="margin-top:10px;">
                            <a href="{{ route('admin.storage-details.by-storage', $storage->id) }}"
                               class="btn btn-default btn-sm">
                                <i class="fa fa-archive"></i> Xem sản phẩm trong lô này
                            </a>
                        </div>
                    @endif
